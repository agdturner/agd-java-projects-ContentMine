...
public class CM_ParsePDF {

    /**
     * @param f A file in PDF format.
     * @return A String of text stripped from the file or null if a IOException
     * was encountered.
     */
    public static String getText(File f) {
        try {
            ...
            Logger.getLogger(CM_ParsePDF.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
     ...
     * was encountered.
     */
    public static String getText(File f, int startPage, int endPage) {
        try {
            String r;
            try (PDDocument doc = PDDocument.load(f)) {
                PDFTextStripper ts = new PDFTextStripper();
     ...
     * @throws SAXException
     */
    public static ArrayList<String[]> parseForLinks(File f, String filter,
